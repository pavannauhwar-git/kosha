    ...
    <div className="page">
      <header className="relative min-h-[34vh] md:min-h-[38vh] -mx-4 px-4 pt-4 pb-7 flex flex-col justify-end mb-2"
        ...
        <div className="relative z-[1]">
          ...
          <h1 className="oneui-title text-ink m-0">Guide</h1>
          <p className="text-label text-ink-3 mt-1.5">Operational playbooks for every finance workflow.</p>
        </div>
      </header>

      <div className="pb-24 max-w-[860px] mx-auto">
