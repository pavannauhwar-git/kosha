...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-kosha-bg px-4 flex flex-col items-center justify-center overscroll-none" style={{ paddingTop: 'max(1.5rem, env(safe-area-inset-top))', paddingBottom: 'max(1.5rem, env(safe-area-inset-bottom))' }}>
