  ...
  return (
    <div className="min-h-dvh bg-kosha-bg flex flex-col px-5 pt-16 pb-10">
      <div className="w-full max-w-sm mx-auto flex flex-col flex-1">
        ...
        {/* Kosha wordmark */}
        <div className="inline-flex items-center justify-center px-3 h-8 rounded-xl bg-brand">
          <span className="text-white font-bold text-sm tracking-tight">KOSHA</span>
        </div>
