import {
  ...
  Certificate, Tag, ArrowUDownLeft,
  Handbag, BowlFood, Popcorn, Hammer, Broom, ShirtFolded,
  Phone, Bus, Gavel, Ticket, Confetti,
  MoneyWavy, HandCoins, Coins, Sparkle, ArrowsCounterClockwise,
  CashRegister, Plant, Cigarette,
