    ...
    <AnimatePresence>
      {message && (
        <motion.div
          ...
          aria-live="polite"
          aria-atomic="true"
          className="fixed bottom-[calc(var(--ds-nav-height)+1.25rem)] left-4 right-4 z-50 flex items-center gap-3 bg-ink dark:bg-kosha-bg backdrop-blur-md text-on-grad border border-on-grad/10 px-4 py-3 rounded-card shadow-apple-card max-w-[400px] mx-auto"
        >
