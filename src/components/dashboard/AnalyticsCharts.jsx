  ...
  return (
    <div className="card p-4 transition-transform duration-150 hover:-translate-y-0.5">
      <div className="mb-3 flex items-start justify-between gap-3">
        <div>
          <p className="text-label font-semibold" style={{ color: 'rgba(30,21,51,0.92)' }}>
            Cash Flow Pulse
          </p>
          <p style={{ fontSize: 11, color: 'rgba(56,39,88,0.55)', marginTop: 2 }}>
        ...
        <div className="text-right">
          ...
          <p style={{ fontSize: 10, color: 'rgba(56,39,88,0.55)', marginTop: 1 }}>earned</p>
        </div>
      </div>
      ...
      <ResponsiveContainer width="100%" height={chartH}>
        <AreaChart data={safeData} margin={{ top: 8, right: 16, left: 12, bottom: 0 }}>
          ...
          <XAxis dataKey="name"
            tick={{ fontSize: 11, fill: 'rgba(56,39,88,0.58)', fontWeight: 500 }}
            axisLine={false} tickLine={false} interval={0}
          />
          <YAxis hide />
          <Tooltip content={<DarkTooltip />} cursor={{ stroke: 'rgba(30,21,51,0.10)', strokeWidth: 1 }} />
      ...
      <div className="flex justify-center gap-6 pb-1 pt-2">
        {[['Income', C.chartIncome], ['Spent', C.chartExpense]].map(([l, c]) => (
          <div key={l} className="flex items-center gap-1.5">
            ...
            <span style={{ fontSize: 11, color: 'rgba(56,39,88,0.60)', fontWeight: 500 }}>{l}</span>
          </div>
        ))}
      </div>
    </div>
    ...
    <div className="card p-4 transition-transform duration-150 hover:-translate-y-0.5">
      <div className="mb-3 flex items-start justify-between gap-3">
        ...
        <div className="text-right">
          ...
          <p style={{ fontSize: 10, color: 'rgba(56,39,88,0.55)', marginTop: 1 }}>
      ...
      <ResponsiveContainer width="100%" height={180}>
        <BarChart data={safeData} margin={{ top: 4, right: 12, left: 12, bottom: 0 }}>
          ...
          <Tooltip content={<NetTooltip />} cursor={{ fill: 'rgba(30,21,51,0.06)' }} />
          <ReferenceLine y={0} stroke="rgba(30,21,51,0.22)" strokeWidth={1} />
