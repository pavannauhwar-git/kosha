    ...
    <div className="card p-4">
      ...
      <div className="grid grid-cols-2 gap-2 mb-2.5">
        <div className="rounded-card bg-kosha-surface-2 p-2.5">
          ...
          <p className="text-[13px] font-semibold tabular-nums text-expense-text">{fmt(analysis.fixed)}</p>
        ...
        <div className="rounded-card bg-kosha-surface-2 p-2.5">
          ...
          <p className="text-[13px] font-semibold tabular-nums text-ink">{fmt(analysis.variable)}</p>
