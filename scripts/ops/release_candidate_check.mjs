...
const CHECKS = [
  ...
  { label: 'Mutation paths', command: ['npm', ['run', 'lint:mutation-paths']] },
  { label: 'Mutation integration', command: ['npm', ['run', 'lint:mutation-integration']] },
  { label: 'Mutation rollback contract', command: ['npm', ['run', 'lint:mutation-rollback']] },
  { label: 'Splitwise math', command: ['npm', ['run', 'test:splitwise-math']] },
  { label: 'Splitwise mutation paths', command: ['npm', ['run', 'lint:splitwise-mutation-paths']] },
